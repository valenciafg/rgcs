...
class CKEditor(object):
    ...
    """
    def __init__(self, db, download_url=('static','certificaciones')):
    ...
    def define_tables(self, migrate=True, fake_migrate=False):
        ...
        self.settings.table_upload = self.db.define_table(upload_name,
            ...
            Field('upload', 'upload',uploadfolder=os.path.join(current.request.folder,'static/certificaciones')),
    ...
    def handle_upload(self):
        ...
        path = os.path.join(current.request.folder, 'static/certificaciones')
